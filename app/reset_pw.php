            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Resetar Senha</h5>
                    <p class="text-center small">Escreva a sua nova senha!</p>
                  </div>
                  ...
                  <form method="POST" class="row g-3" >
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Escreva uma senha valida</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="confirmpassword" name="confirmpassword" class="form-control" id="email" required>
                        <div class="invalid-feedback">Escreva uma senha valida</div>
                      </div>
                    </div>
